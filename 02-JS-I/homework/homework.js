...
function esPositivo(numero) {
  ...
  if (numero<0){return "Es negativo"}else{if (numero>0){return "Es positivo"}else{return false}};
}
...
function esVocal(letra){
  ...
  //Escribe tu código aquí
  if (letra.length>1){return "Dato incorrecto"}else{if (letra= "a" || "e"||"i"||"o"||"u"){return "Es vocal"}}
}
