  ...
  if(idioma==="aleman"){return "Guten Tag!"}else{
    if(idioma==="mandarin"){return "Ni Hao!"}else{
      if(idioma==="ingles"){return "Hello!"}else{
        if(idioma===undefined){return "Hola!"}else{
          return "Hola!"
        }
      }
    }
...
function fizzBuzz(numero) {
  ...
  if(numero%5===0 && numero%3===0){return "fizzbuzz"}else{
    if(numero%5===0){return"buzz"}else{
      if(numero%3===0){return "fizz"}else{ return numero}
    }
  }
}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if (num1===0 || num2===0 || num3===0){return "Error"}{
    ...
    if(num3>num1 && num3>num2){num3=num3+1; return num3}
  }{return false}
}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí  
  let tabla6=[];
  for(let i=0;i<11;i++){tabla6.push(6*i)} return tabla6;
}
